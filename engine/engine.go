...
type Engine interface {
	Publish(namespace string, queue Queue, body []byte, ttlSecond, delaySecond uint32, tries uint16) (jobID string, err error)
	...
	Delete(namespace string, queue Queue, jobID string) error
