...
func setupMetrics() {
	...
	metrics = &Metrics{
		...
		publishQueueJobs:      cv("publish_queue_jobs", "namespace", "queue", "queue_tag"),
		consumeQueueJobs:      cv("consume_queue_jobs", "namespace", "queue", "queue_tag"),
		jobElapsedMS:          sv("job_elapsed_ms", "namespace", "queue", "queue_tag"),
		jobAckElapsedMS:       sv("job_ack_elapsed_ms", "namespace", "queue", "queue_tag"),

		timerSizes:      gv("timer_sizes"),
		queueSizes:      gv("queue_sizes", "namespace", "queue", "queue_tag"),
		deadletterSizes: gv("deadletter_sizes", "namespace", "queue", "queue_tag"),
